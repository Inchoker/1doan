...
public class BookingRestController {
    ...
    public BookingDTO AddBookingInfo(@RequestBody BookingDTO bookingDTO) {
        bookingService.updateToCOM(bookingDTO);
        return bookingDTO;
    }
    ...
    @PutMapping("/updateToWFP/{id}")
    public void updateBookingToWFP(@PathVariable int id) {
        System.out.println(id);
        timeBookingDetailService.deleteByBookingId(id);
        bookingDetailService.deleteByBookingId(id);
        bookingService.updateWFP(id);
    }
    ...
    public List<ThongBaoUCF> alertBookingUCF() {
        try {
            bookingService.alertBookingUCF();
        } catch (Exception e) {
            System.out.println(e);
        }
